...
//nestedFunction();const external = "I'm outside the function";
...
// The nested function can access the variable 'internal' because of closures, which allow an inner function to access the scope of its containing (outer) function, even after the outer function has returned.
...
// Log the result of invoking summation(4)
...
// Given this zoo data from around the United States, follow the instructions below. Use the specific array methods in the requests below to solve the problems.console.log(summation(8));
...
const zooAnimals = [
  ...
  */
  ...
  zooAnimals.forEach(animal => {
    ...
    const displayName = `name: ${name}, scientific: ${scientificName}`;
...
function lowPopulationAnimals(zooAnimals){
  ...
  */
  ...
  const totalPopulation = zooAnimals.reduce((total, animal) => {
...
// Test consumer function with add, multiply and greeting callbacks
